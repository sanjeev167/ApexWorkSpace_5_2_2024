...
/**
 * JPA entity class for "OperationMstr"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="operation_mstr", schema="public" )
public class OperationMstr implements Serializable {
    ...
    @JsonIgnore
    @OneToMany(mappedBy="operationMstr")
