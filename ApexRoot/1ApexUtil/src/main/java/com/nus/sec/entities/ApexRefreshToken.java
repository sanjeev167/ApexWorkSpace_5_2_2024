...
/**
 * JPA entity class for "ApexRefreshToken"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="apex_refresh_token", schema="public" )
public class ApexRefreshToken implements Serializable {
