...
public class ProjectMonthlyPlcc implements Serializable {
    ...
    public ProjectMonthlyPlcc(Date fileUploadDate, int userId, String activeC) {    	
    ...
    public ProjectCodeMstr getProjectCodeMstr() {
		return projectCodeMstr;
	}

	public void setProjectCodeMstr(ProjectCodeMstr projectCodeMstr) {
		this.projectCodeMstr = projectCodeMstr;
	}
