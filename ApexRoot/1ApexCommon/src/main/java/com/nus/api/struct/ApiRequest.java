 ...
 * @Objective: <br>
 */
@JsonPropertyOrder({ "api_url", "method", "payLoad", "requested_at", "responded_at" })
public class ApiRequest {
	...
	public ApiRequest(String api_url, String method, String inContent_Type, String outContent_Type, String requested_at,
			String responded_at,String logIn) {
		super();
