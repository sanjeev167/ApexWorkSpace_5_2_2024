...
/**
 * JPA entity class for "HprojectMonthlyResourceUtilization"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="hproject_monthly_resource_utilization", schema="public" )
public class HprojectMonthlyResourceUtilization implements Serializable {
     ...
     * Constructor
     */
    public HprojectMonthlyResourceUtilization() {
		super();
    }
