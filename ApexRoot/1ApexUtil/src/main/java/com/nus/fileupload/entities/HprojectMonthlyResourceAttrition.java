...
/**
 * JPA entity class for "HprojectMonthlyResourceAttrition"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="hproject_monthly_resource_attrition", schema="public" )
public class HprojectMonthlyResourceAttrition implements Serializable {
     ...
     * Constructor
     */
    public HprojectMonthlyResourceAttrition() {
		super();
    }
