...
public class UserTypeController extends ApexBaseCtrl {
	...
	public ResponseEntity<Object> addUserType(@RequestBody UserTypeModel userTypeModel) throws Exception {		
	...
	@PreAuthorize("hasAnyAuthority('ROLE_SUPER','ROLE_ADMIN')")
	public ResponseEntity<Object> getAllUserTypes() throws Exception {		
	...
	@PreAuthorize("hasAnyAuthority('ROLE_SUPER','ROLE_ADMIN')")
	public ResponseEntity<Object> getUserTypeById(@PathVariable("id") Integer id) throws Exception {
	...
	@PreAuthorize("hasAnyAuthority('ROLE_SUPER','ROLE_ADMIN')")
	public ResponseEntity<Object> deleteUserTypeById(@PathVariable("id") Integer id) throws Exception {
	...
	@PreAuthorize("hasAnyAuthority('ROLE_SUPER','ROLE_ADMIN')")
	public ResponseEntity<Object> updateUserType(@RequestBody UserTypeModel UserTypeModel) throws Exception {		
