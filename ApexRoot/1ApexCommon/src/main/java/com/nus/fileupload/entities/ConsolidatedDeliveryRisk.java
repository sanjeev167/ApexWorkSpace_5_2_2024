...
public class ConsolidatedDeliveryRisk implements Serializable {
    ...
    @Column(name="risk_main_category", nullable=false, length=2147483647)
    private String     riskMainCategory ;

    @Column(name="risk_sub_category", nullable=false, length=2147483647)
    private String     riskSubCategory ;

    @Column(name="occuring_probablity", nullable=false, length=50)
    ...
    public ConsolidatedDeliveryRisk(Date fileUploadDate, int userId, String activeC) {
