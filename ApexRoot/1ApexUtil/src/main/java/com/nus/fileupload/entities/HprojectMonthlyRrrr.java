...
/**
 * JPA entity class for "HprojectMonthlyRrrr"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="hproject_monthly_rrrr", schema="public" )
public class HprojectMonthlyRrrr implements Serializable {
