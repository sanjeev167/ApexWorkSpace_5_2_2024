...
/**
 * JPA entity class for "ProjectTypeMstr"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="project_type_mstr", schema="public" )
public class ProjectTypeMstr implements Serializable {
    ...
    @JsonIgnore
    @OneToMany(mappedBy="projectTypeMstr")
