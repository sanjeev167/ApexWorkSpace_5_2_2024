...
/**
 * JPA entity class for "RoleHierarchy"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="role_hierarchy", schema="public" )
public class RoleHierarchy implements Serializable {
    ...
    @Column(name="parent_in_hierarchy_id")
    private Integer    parentInHierarchyId ;
    ...
    @JsonIgnore
    @ManyToOne
    @JoinColumn(name="parent_in_hierarchy_id", referencedColumnName="id", insertable=false, updatable=false)
    ...
    public void setParentInHierarchyId( Integer parentInHierarchyId ) {
        this.parentInHierarchyId = parentInHierarchyId ;
    }
    public Integer getParentInHierarchyId() {
        return this.parentInHierarchyId;
    }
