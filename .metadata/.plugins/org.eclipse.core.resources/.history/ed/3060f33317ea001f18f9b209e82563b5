...
/**
 * JPA entity class for "HprojectMonthlyPlcc"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="hproject_monthly_plcc", schema="public" )
public class HprojectMonthlyPlcc implements Serializable {
