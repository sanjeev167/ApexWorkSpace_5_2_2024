...
public class GlobalLogger {
	...
	public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
		logger.error("NUS => Exception in {}.{}() with cause = {}", joinPoint.getSignature().getDeclaringTypeName(),
	...
	public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		if (logger.isInfoEnabled()) {
			logger.info("NUS => Enter: {}.{}() with argument[s] = {}", joinPoint.getSignature().getDeclaringTypeName(),
		...
		try {
			...
			if (logger.isInfoEnabled()) {
				logger.info("NUS => Exit: {}.{}() with result = {}", joinPoint.getSignature().getDeclaringTypeName(),
		...
		// [3] Corresponding to calculating Method-Execution-Time
			...
			logger.info("NUS => Execution time of "
			...
			logger.error("NUS => Illegal argument: {} in {}.{}()", Arrays.toString(joinPoint.getArgs()),
